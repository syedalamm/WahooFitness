...
//		}
	...
	public void beforeFindBy(By by, WebElement element, WebDriver driver) {
		...
		if (element == null) {
			System.out.println(
					timeStamp + "Just before finding element: " + by.toString() + " on browser: " + driver.toString());

		} else {
			System.out.println(timeStamp + "Just before finding element: " + by.toString() + " inside "
					+ element.toString() + " Web element on browser: " + driver.toString());
		}
